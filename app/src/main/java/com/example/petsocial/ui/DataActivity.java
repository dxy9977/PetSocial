...
public class DataActivity extends BaseMvpActivity<DataPresenter> implements DataContract.View, View.OnClickListener {
    ...
    private List<DataEntity.NewsBean> data;

    private ImageView headIcon;
    private TextView headName, headPhone, headQian, headText1, headText2, headText3;
    ...
    public void initView() {
        ...
        mPresenter.loadData(getIntent().getIntExtra("id", 0));
